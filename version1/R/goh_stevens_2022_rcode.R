...
all_data <- read_csv(here("data/goh_stevens_2022_data.csv"), col_names = TRUE)  # import data
...
ggsave(here("figures/itc_social_info_1.png"), width = 14, height = 7.5)
...
ggplot(nonsocial_social_DS_SD_plot_1, aes(x = itc_task, y = choice, fill = itc_task)) +  # create graph axes labels, add fill color to boxplot
  ...
  theme(axis.title.y = element_text(face = "bold", size = 26, margin = margin(t = 0, r = 10, b = 0, l = 0)),  #  change y axis title font, size & margin
        ...
        strip.text.x = element_text(size = 23),  # change facet label size
        legend.position = "none")  # remove legend from graph
ggsave(here("figures/socialinfo_ds_sd_1.png"), width = 6.5, height = 6.5)  # save plot to "figures" folder
...
ggsave(here("figures/sim_judgment_predictions_combined_1.png"), width = 15, height = 6.5)
...
ggsave(here("figures/suggestibility_itc_1.png"), width = 14, height = 7.5)
...
(bnt_judgments_plot_1 + sns_judgments_plot_1) +
  plot_annotation(tag_levels = 'a', tag_prefix = "(", tag_suffix = ')') &
  theme(plot.tag = element_text(size = 20))
ggsave(here("figures/numeracy_judgments_1.png"), width = 14, height = 7.5)
...
(bnt_itc_plot_1 + sns_itc_plot_1) +
  plot_annotation(tag_levels = 'a', tag_prefix = "(", tag_suffix = ')') &
  theme(plot.tag = element_text(size = 20))
ggsave(here("figures/numeracy_itc_1.png"), width = 14, height = 7.5)
...
itc_socialinfo_plot_2 <- ggplot(itc_choice_data_2, aes(x = amount_delay_social_info, y = choice, fill = amount_delay_social_info)) +
  ...
  theme(axis.title.y = element_text(face = "bold", size = 26, margin = margin(t = 0, r = 10, b = 0, l = 0)),  # change y axis title font, size & margin
        ...
        strip.text.x = element_text(size = 23),  # change facet label size
        legend.position = "none")  # remove legend from graph
ggsave(here("figures/itc_social_info_2.png"), width = 6.5, height = 6.5)
...
socialinfo_ds_sd_2 <- ggplot(nonsocial_social_DS_SD_plot_2, aes(x = itc_task, y = choice, fill = itc_task)) +  # create graph axes labels, add fill color to boxplot
  ...
  theme(axis.title.y = element_text(face = "bold", size = 26, margin = margin(t = 0, r = 10, b = 0, l = 0)),  #  change y axis title font, size & margin
        ...
        strip.text.x = element_text(size = 23),  # change facet label size
        legend.position = "none")  # remove legend from graph
# ggsave(here("figures/socialinfo_ds_sd_2.png"), width = 6.5, height = 6.5)  # save plot to "figures" folder
...
(sim_judgments_itc_predictions_personal_domain_2 + sim_judgments_itc_predictions_social_domain_2) +
  plot_annotation(tag_levels = 'a', tag_prefix = "(", tag_suffix = ')') &
  theme(plot.tag = element_text(size = 25))
ggsave(here("figures/sim_judgment_predictions_combined_2.png"), width = 15, height = 6.5)
...
(suggestibility_ds_plot_2 + suggestibility_sd_plot_2) +
  plot_annotation(tag_levels = 'a', tag_prefix = "(", tag_suffix = ')') &
  theme(plot.tag = element_text(size = 20))
ggsave(here("figures/suggestibility_itc_2.png"), width = 14, height = 7.5)
...
(bnt_judgments_plot_2 + sns_judgments_plot_2) +
  plot_annotation(tag_levels = 'a', tag_prefix = "(", tag_suffix = ')') &
  theme(plot.tag = element_text(size = 20))
ggsave(here("figures/numeracy_judgments_2.png"), width = 14, height = 7.5)
...
(bnt_itc_plot_2 + sns_itc_plot_2) +
  plot_annotation(tag_levels = 'a', tag_prefix = "(", tag_suffix = ')') &
  theme(plot.tag = element_text(size = 20))
ggsave(here("figures/numeracy_itc_2.png"), width = 14, height = 7.5)
...
(judgments_plot_similar_interaction_plot_3 + judgments_plot_dissimilar_interaction_plot_3) +
  plot_annotation(tag_levels = 'a', tag_prefix = "(", tag_suffix = ')') &
  theme(plot.tag = element_text(size = 25))
ggsave(here("figures/judgments_socialinfo_combined_3.png"), width = 15, height = 6.5)
...
ggplot(suggestibility_plot_3, aes(x = social_info_condition, y = mean_similarity_judgment, fill = social_info_condition)) +
  ...
  theme(axis.title.y = element_text(face = "bold", size = 26, margin = margin(t = 0, r = 10, b = 0, l = 0)),  # change y axis title font, size & margin
        ...
        strip.text.x = element_text(size = 23),  # change facet label size
        legend.position = "none")  # remove legend from graph
ggsave(here("figures/suggestibility_social_info_3.png"), width = 6.5, height = 6.5)  # save plot to "figures" folder
...
(bnt_judgments_plot_3 + sns_judgments_plot_3) +
  plot_annotation(tag_levels = 'a', tag_prefix = "(", tag_suffix = ')') &
  theme(plot.tag = element_text(size = 20))
ggsave(here("figures/numeracy_judgments_3.png"), width = 14, height = 7.5)
